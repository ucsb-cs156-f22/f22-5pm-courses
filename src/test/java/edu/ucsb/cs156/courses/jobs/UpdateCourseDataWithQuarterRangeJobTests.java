...
public class UpdateCourseDataWithQuarterRangeJobTests {
    ...
    void test_log_output_success() throws Exception {
        ...
        UpdateCourseDataWithQuarterRangeJob updateCourseDataWithQuarterRangeJob = new UpdateCourseDataWithQuarterRangeJob("20211", "20221", 
                ucsbSubjectsService, ucsbCurriculumService, convertedSectionCollection);
        ...
        updateCourseDataWithQuarterRangeJob.accept(ctx);
    ...
    void test_log_output_with_updates() throws Exception {
        ...
        UpdateCourseDataWithQuarterRangeJob updateCourseDataWithQuarterRangeJob = new UpdateCourseDataWithQuarterRangeJob("20211", "20221", ucsbSubjectsService, ucsbCurriculumService,
